...
#LORS
LORS=read.csv(paste(data.path,"LORS.csv",sep=""))
LORS$Year=CurWY-1
...
### ***Lake Okeechobee Relative Algae Condition***
...
<font size=4><center> Sonde monitoring locations within Lake Okeechobee conducted by SFWMD.</center></font>

```{r LO sonde plot,echo=FALSE,fig.width=8,fig.height=5,fig.align='center'}
...
<font size=4><center> Daily Chlorophyll, Phycocyanin,relative ratio of Phycocyanin (Phyco) relative to Phyco and Chlorophyll (Chl) and Turbidity within Lake Okeechobee monitored by SFWMD.</center></font>
<font size=5 color="red">
<center>Data are provisional and subject to change.</center></font>
...
fb.dat=data.frame(Lat=c(25.167,25.12,25.106,c(25.21,25.217,25.176,25.157),c(25.053,25.073,25.180,25.235),c(24.981,25.027,25.087,25.178)),
           ...
           Data.Source="DBHydro",
           Parameter="Salinity")
LakeO.sonde=data.frame(Lat=c(27.14,27.03,26.99,26.96,26.90,26.82),
                       Long=c(-80.79,-80.90,-80.87,-80.97,-80.79,-80.78),
                       Station=c("L001","POLESOUT1","POLESOUT3","L005","LZ40","L006"),
                       Database.Name=c("L001-S","POLESOUT1-S","POLESOUT3-S","L005-S","LZ40-S","L006-S"),
                       Data.Source="DBHydro",
                       Parameter="Chlorophyll, Phycocyanin and Turbitiy")
dat=rbind(dat,fb.dat,LakeO.sonde)
